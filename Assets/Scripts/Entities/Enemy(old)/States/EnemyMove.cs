...
namespace Entities.Enemy.States
{
    public class EnemyMove : EnemyState
    {
        ...
        private void ForceDecelerate()
        {
            ...
            velocity.x = Mathf.Lerp(velocity.x, 0f, Controller.stats.movementSpeed * Time.deltaTime);
            velocity.y = Mathf.Lerp(velocity.y, 0f, Controller.stats.movementSpeed * Time.deltaTime);
